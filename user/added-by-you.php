...
<body>
	...
	<div class="btn-group-vertical" id="problem">
		<?php
		$i = 1;
		while($row=mysqli_fetch_array($result))
		{
		...
		<div class="container">
			<ul class="pagination">
				<?php echo "<li><a onclick='javascript:loadDoc(\"added-by-you.php?page=".$pre."\",\"problem\")' class='button'>PREVIOUS</a></li>"; ?>

				<?php
					for($page=1;$page<=$no_of_pages;$page++)
					{
						$url = "added-by-you.php?page=".$page."";
				?>
				<script>
					alert("apple");
				...
				<?php
					...
					echo "<li><a onclick='javascript:loadDoc(\"added-by-you.php?page=".$next."\",\"problem\")' class='button'>NEXT</a></li>";
				?>
			</ul>
		</div>
	</div>
