    ...
    <body>
		<form>
			...
			<div style="position: relative;top: 50%;">
				...
				<button type="button" class="btn btn-primary" onclick="if(!(document.getElementById('issue').value)){alert('Enter the issue');}generateUrl((document.getElementById('state2').value),(document.getElementById('district2').value),(document.getElementById('locality2').value),(document.getElementById('pin2').value),(document.getElementById('issueTitle').value),'field','add')">Next</button>
				</div>
			</div>
